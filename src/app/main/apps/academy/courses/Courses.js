...
import MaintenenceTable from './MaintenenceTable';
    ...
    <FusePageSimple
      ...
      content={
        <div className="flex flex-col flex-1 w-full mx-auto px-24 pt-24 sm:p-40">
          <Typography className="text-3xl font-medium font-large mb-40 tracking-tight leading-6 truncate">Preventation Maintenance Schedules</Typography>
          <div className="flex flex-col shrink-0 sm:flex-row mb-40 items-center justify-between space-y-16 sm:space-y-0">

...
const cardsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(getCards.fulfilled, cardsAdapter.setAll)
      ...
      .addCase(newCard.fulfilled, cardsAdapter.addOne)
      .addCase(updateCard.fulfilled, cardsAdapter.setOne)
      .addCase(removeCard.fulfilled, cardsAdapter.removeOne);
  },
});

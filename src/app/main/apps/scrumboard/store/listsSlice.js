...
const listsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(getLists.fulfilled, listsAdapter.setAll)
      .addCase(updateList.fulfilled, listsAdapter.setOne)
      .addCase(removeList.fulfilled, listsAdapter.removeOne)
      .addCase(newList.fulfilled, listsAdapter.addOne);
  },
});

...
export default function EstatePlannerClientsPage() {
  const { toast } = useToast()
  const { request } = useApi()
  const [clients, setClients] = useLocalStorage<Client[]>('estate-planner-clients', [])
  ...
  const stats = React.useMemo(() => ({
    ...
    totalPlans: clients.reduce((sum, c) => sum + (c.plansCount || 0), 0),
  }), [clients])
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Manage your client accounts and invite new clients for estate planning services
                </p>
              </div>
              <Button
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <Card className="border border-border/60">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-2xl font-semibold text-foreground">{stats.totalPlans}</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-xs mt-0.5">
                          {client.plansCount || 0} {client.plansCount === 1 ? 'Plan' : 'Plans'}
                        </CardDescription>
                      </div>
                    </div>
              ...
              <CardContent className="py-16 text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-md mx-auto mb-4">
                  {searchQuery || filterStatus !== 'all'
                    ...
                    : 'Invite clients to start their estate planning journey with you.'}
                </p>
                {(!searchQuery && filterStatus === 'all') && (
                  <Button
                    onClick={() => setIsInviteOpen(true)}
      ...
      <Dialog open={isInviteOpen} onOpenChange={setIsInviteOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Send an invitation to a client to start their estate planning. They will receive an email with instructions to create their account.
            </DialogDescription>
          </DialogHeader>

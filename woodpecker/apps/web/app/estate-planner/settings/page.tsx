...
export default function EstatePlannerSettingsPage() {
  const { user } = useUser()
  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      <main className="flex-1 overflow-y-auto">
        <PageIntro pageId="estate-planner-settings" pageName="ESTATE PLANNER SETTINGS">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
            {/* Header */}
            <div className="mb-6">
              <h1 className="text-2xl font-semibold text-foreground mb-1.5">
                Estate Planner Settings
              </h1>
              <p className="text-sm text-muted-foreground">
                Manage your estate planner profile, security, and preferences.
              </p>
            </div>
            ...
            <Tabs defaultValue="profile" className="space-y-6">
              ...
              <TabsContent value="profile">
                <Card className="border border-border">
                  <CardHeader>
                    <CardTitle className="text-base">Estate Planner Profile</CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="md:col-span-2">
                        <Label htmlFor="firm">Estate Planning Firm</Label>
                        <Input
                          id="firm"
                          placeholder="Your estate planning firm name"
                          className="mt-1"
                        />
                      </div>
                      <div className="md:col-span-2">
                        ...
                        <Input
                          id="specialization"
                          placeholder="E.g., Estate Planning, Trust Administration"
                          className="mt-1"
                        />
                      </div>
                    </div>
              ...
              <TabsContent value="notifications">
                <Card className="border border-border">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>Estate Plan Updates</Label>
                        <p className="text-xs text-muted-foreground">Notifications about estate plan changes</p>
                      </div>
                      <input type="checkbox" defaultChecked className="h-4 w-4" />
                    </div>
                    <div className="flex justify-end gap-2 pt-4">
